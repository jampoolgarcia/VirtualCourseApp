...
export class StudentController {
  ...
  async create(
    ...
    let password1 = new EncryptDecrypt(ServiceKeys.LOGIN_CRYPT_METHOD).Encrypt(s.document);
    let password2 = new EncryptDecrypt(ServiceKeys.LOGIN_CRYPT_METHOD).Encrypt(password1);
    let u = {
      userName: s.document,
      password: password2,
      role: 1,
